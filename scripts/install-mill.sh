...
# require the verison to install to be passed in the script parameter.
...
[ $VERSION -ge $MINIMUM_MILL_VERSION ] || { echo "Usage: install-mill [MILL_VERSION] MILL_VERSION >= 0.5.0"; exit 1;}
